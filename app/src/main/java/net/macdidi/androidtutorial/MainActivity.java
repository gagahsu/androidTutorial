    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (item.getAlarmDatetime() != 0 && updateAlarm) {
                ...
                PendingIntent pi = PendingIntent.getBroadcast(this, (int)item.getId(), intent, PendingIntent.FLAG_ONE_SHOT);
        ...
        AdapterView.OnItemClickListener itemListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (selectedCount > 0) {
                    ...
                    intent.putExtra("net.macdidi.androidtutorial.Item", item);
    ...
    public void clickMenuItem(MenuItem item) {
        ...
        switch (itemId) {
            ...
            case R.id.add_item:
                ...
                Intent intent = new Intent("net.macdidi.androidtutorial.ADD_ITEM");
